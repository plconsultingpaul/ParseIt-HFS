    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          maxLength={5}
          className={`w-full px-4 py-2 pl-10 border rounded-lg bg-white dark:bg-gray-700 dark:hover:bg-black text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 transition-colors ${
            error
