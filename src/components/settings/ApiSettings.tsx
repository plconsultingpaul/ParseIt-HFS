    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Configure API settings for JSON data transmission</p>
        </div>
      ...
      {saveSuccess && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-green-700 text-sm mt-1">API configuration saved successfully!</p>
        </div>
      )}
        ...
        <div className={`border rounded-lg p-4 ${
          ...
          {testResult.data && (
            <div className="mt-3 bg-white rounded-lg p-3 border">
              <p className="text-xs font-medium text-gray-600 mb-2">API Response:</p>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">API Endpoint</h4>
              <p className="text-sm text-gray-500">Base URL for JSON data transmission</p>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Google Gemini API</h4>
              <p className="text-sm text-gray-500">API key for PDF data extraction</p>
            </div>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h4 className="font-semibold text-blue-800 mb-2">How API Integration Works</h4>
