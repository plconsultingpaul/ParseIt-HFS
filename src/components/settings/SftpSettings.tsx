  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold text-gray-900">SFTP Configuration</h3>
          <p className="text-gray-600 mt-1">Configure SFTP server settings for file uploads</p>
        </div>
      ...
      {saveSuccess && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-green-700 text-sm mt-1">SFTP configuration saved successfully!</p>
        </div>
      )}
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Server Connection</h4>
            <p className="text-sm text-gray-500">SFTP server details</p>
          </div>
        </div>
